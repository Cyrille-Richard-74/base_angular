//======================================================================
// CORE / INTERCEPTORS / ERROR HANDLER
// Catch errors from HTTP Response
//======================================================================
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        return next.handle(request).pipe(catchError(response => {
            ...
            switch (response.status) {
                case 0:
                    this.toastr.error('Server is not responding', response.name);
                    break;
                ...
                //   case 400:
                //   // Catch the code 401 (Unauthorized) from the server
                //   // Force to logout
                //   case 401:
